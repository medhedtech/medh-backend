...
export const createAssignment = catchAsync(async (req, res) => {
  ...
  res
    .status(201)
    .json(formatResponse(newAssignment, "Assignment created successfully"));
});
...
export const updateAssignment = catchAsync(async (req, res) => {
  ...
  res
    .status(200)
    .json(formatResponse(updatedAssignment, "Assignment updated successfully"));
});
...
export const getSubmittedAssignmentsCountByInstructor = catchAsync(
  async (req, res) => {
...
export const getAssignmentsForCoorporateEnrolledCourses = catchAsync(
  async (req, res) => {
