  ...
  try {
    ...
    const response = {
      ...
      data: {
        ...
        personal_details: {
          date_of_birth: user.date_of_birth || user.meta?.date_of_birth,
          gender: user.gender || user.meta?.gender,
          nationality: user.nationality || user.meta?.nationality,
          languages_spoken: user.languages_spoken || user.meta?.languages_spoken || [],
          occupation: user.current_occupation || user.meta?.occupation,
          industry: user.meta?.industry,
          company: user.company_name || user.meta?.company,
          experience_level: user.experience_level || user.meta?.experience_level,
          annual_income_range: user.meta?.annual_income_range,
          education_level: user.education_level || user.meta?.education_level,
          institution_name: user.institution_name || user.meta?.institution_name,
          field_of_study: user.field_of_study || user.meta?.field_of_study,
          graduation_year: user.graduation_year || user.meta?.graduation_year,
          skills: user.skills || user.meta?.skills || [],
          certifications: user.certifications || user.meta?.certifications || [],
          learning_goals: user.learning_goals || user.meta?.learning_goals || [],
          preferred_learning_style: user.preferred_learning_style || user.meta?.preferred_learning_style,
          available_time_per_week: user.meta?.available_time_per_week,
          preferred_study_times: user.preferred_study_times || user.meta?.preferred_study_times || [],
          interests: user.interests || user.meta?.interests || [],
        },
