...
console.log('\n🔍 Checking MedhDB Database');
console.log('===========================');
console.log(`📊 Database: ${mongoose.connection.db.databaseName}`);

// List all collections in MedhDB
...
console.log('\n🔍 Checking users collection in MedhDB...');
...
if (studentUser) {
  console.log(`✅ Found student@medh.co in MedhDB!`);
  ...
  console.log('❌ student@medh.co not found in MedhDB users collection');
}
